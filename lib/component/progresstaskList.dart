...
class ProgressTaskController extends GetxController {
  ...
  var status = "Progress".obs; // Observable for task status
  ...
  Future<void> updateStatus(id) async {
    ...
    await callData();
    status.value = "Progress"; // Reset status to Progress
  }
...
class ProgressTaskList extends StatelessWidget {
  ...
  void statusChange(
      BuildContext context, int id, ProgressTaskController controller) {
