...
class TaskController extends GetxController {
  ...
  Future<void> callData(String status) async {
    loading(true);
  ...
  Future<void> updateStatus(String id, String status) async {
    ...
    await callData("Completed"); // Fetch "Completed" tasks after update
    this.status.value = "Completed"; // Reset status to Completed after update
  }
  ...
  Future<void> deleteItem(String id) async {
    ...
    await callData("Completed"); // Refresh the data after deletion
  }
}
...
class TaskListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return controller.loading.value
          ...
          : RefreshIndicator(
              onRefresh: () async {
                await controller.callData("Completed");
              },
  ...
  void statusChange(
      BuildContext context, String id, TaskController controller) {
